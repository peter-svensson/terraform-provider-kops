...
func ResourceKubeletConfigSpec() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"image_minimum_gc_age":                     OptionalDuration(),
			"image_maximum_gc_age":                     OptionalDuration(),
			"max_parallel_image_pulls":                 OptionalInt(),
			...
			"experimental_allocatable_ignore_eviction": OptionalBool(),
...
func ExpandResourceKubeletConfigSpec(in map[string]interface{}) kops.KubeletConfigSpec {
	...
	return kops.KubeletConfigSpec{
		...
		ImageMinimumGCAge: func(in interface{}) *meta.Duration {
			if in == nil {
				return nil
			}
			if reflect.DeepEqual(in, reflect.Zero(reflect.TypeOf(in)).Interface()) {
		...
		ImageMaximumGCAge: func(in interface{}) *meta.Duration {
			if in == nil {
				return nil
			}
			if reflect.DeepEqual(in, reflect.Zero(reflect.TypeOf(in)).Interface()) {
...
func FlattenResourceKubeletConfigSpecInto(in kops.KubeletConfigSpec, out map[string]interface{}) {
	...
	out["image_minimum_gc_age"] = func(in *meta.Duration) interface{} {
		return func(in *meta.Duration) interface{} {
			if in == nil {
				return nil
			}
	...
	out["image_maximum_gc_age"] = func(in *meta.Duration) interface{} {
		return func(in *meta.Duration) interface{} {
			if in == nil {
				return nil
			}
