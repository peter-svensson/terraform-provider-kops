...
func ResourceKubeAPIServerConfig() *schema.Resource {
	res := &schema.Resource{
		Schema: map[string]*schema.Schema{
			...
			"authentication_config_file":                   OptionalString(),
			...
			"audit_webhook_batch_throttle_enable":          Nullable(OptionalBool()),
			...
			"additional_service_account_issuers":           OptionalList(String()),
			...
			"enable_contention_profiling":                  OptionalBool(),
			...
			"delete_collection_workers":                    OptionalInt(),
